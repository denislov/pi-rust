...
use crate::agent::types::{AgentConfig, AgentEvent, AgentMessage, AgentStream, AgentTool};
use crate::hooks::{
...
use crate::testing::error::{AgentHarnessError, AgentHarnessErrorCode};
...
pub struct StreamOptionsPatch {
    ...
    pub thinking: Option<Patch<ThinkingConfig>>,
...
pub mod on_kind {
    //! Marker types for [`super::AgentHarness::on`].
