...
fn capability_revocation_to_protocol(
    revocation: crate::runtime::facade::CodingAgentProductEventCapabilityRevocation,
) -> &'static str {
    match revocation {
        crate::runtime::facade::CodingAgentProductEventCapabilityRevocation::FutureOnly => {
            "future_only"
        }
        crate::runtime::facade::CodingAgentProductEventCapabilityRevocation::RequestCancelOlderOperations => {
...
mod tests {
    ...
    fn protocol_adapter_does_not_masquerade_shutdown_as_prompt_completion() {
        ...
        let product_event = ProductEvent::from_draft_for_tests(
            ProductEventSequence::new(1),
            crate::events::runtime::RuntimeEvent::ShutDown.into_product_draft(),
            None,
        );
