...
pub mod api {
    ...
    pub use crate::coding_session::{
        ...
        CodingAgentDiagnosticProductEvent, CodingAgentMessageProductEvent, CodingAgentOperation,
        ...
        CodingAgentRuntimeProductEvent, CodingAgentSession, CodingAgentSessionExport,
        ...
        CodingAgentSnapshotCursor, CodingAgentTeamProductEvent, CodingAgentToolProductEvent,
