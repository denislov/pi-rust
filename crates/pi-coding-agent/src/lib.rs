...
pub mod api {
    ...
    pub use crate::coding_session::{
        ...
        CodingAgentDiagnosticProductEvent, CodingAgentDraft, CodingAgentDraftId,
        CodingAgentDraftKind, CodingAgentFreshSnapshotRecovery, CodingAgentMessageProductEvent,
        ...
        CodingAgentRecoveryReason, CodingAgentRuntimeProductEvent, CodingAgentSession,
        ...
        CodingDiagnostic, CodingDiagnosticSeverity, CodingSessionError, DelegationConfirmationMode,
        DelegationPolicy, PendingDelegationConfirmation, ProfileDiagnostic, ProfileId, ProfileKind,
