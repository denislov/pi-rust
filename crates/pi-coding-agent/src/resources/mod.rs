...
use pi_tui::api::render::Color;
use pi_tui::api::theme::{ThemePalette, TuiTheme, dark_theme};
...
/// Build a `pi_tui::api::theme::TuiTheme` from a loaded theme resource.
///
...
/// Build a `pi_tui::api::theme::TuiTheme` from a theme name + parsed [`ThemeJson`].
