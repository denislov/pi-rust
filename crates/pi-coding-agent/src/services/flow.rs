...
use crate::operations::branch_summary::flow::{
    BranchSummaryContext, BranchSummaryFlow, BranchSummaryOutcome,
};
use crate::operations::compaction::flow::{
    ManualCompactionContext, ManualCompactionFlow, ManualCompactionOutcome,
};
use crate::operations::export::flow::{ExportContext, ExportFlow, ExportOutcome};
use crate::operations::plugin_load::flow::{PluginLoadContext, PluginLoadFlow, PluginLoadOutcome};
use crate::operations::prompt::context::{PromptTurnContext, PromptTurnOutcome};
use crate::operations::prompt::flow::PromptTurnFlow;
use crate::operations::self_healing_edit::flow::{
    SelfHealingEditContext, SelfHealingEditFlow, SelfHealingEditOutcome,
};
use crate::operations::team_invocation::flow::{AgentTeamContext, AgentTeamFlow, AgentTeamOutcome};
...
mod tests {
    ...
    use pi_agent_core::api::execution::{ExecutionOutput, FileSystem};
    ...
    use crate::runtime::facade::{CodingAgentSessionExportItem, CodingAgentSessionSummary};
    use crate::session::replay::{SessionReplay, TranscriptItem};
    ...
    impl pi_agent_core::api::flow::FlowNode<()> for NoopFlowNode {
        fn name(&self) -> &str {
            "NoopFlowNode"
        }
    ...
    fn add_linear_edges_maps_configuration_errors_to_coding_session_error() {
        let mut flow = pi_agent_core::api::flow::Flow::new("start").unwrap();
    ...
    impl SelfHealingEditRepairStrategy for FixedRepairStrategy {
        fn repair<'a>(
            ...
            _diagnostics: &'a [crate::operations::self_healing_edit::flow::SelfHealingEditDiagnostic],
...
"#,
        ...
        let output = (tools[0].execute)(
            pi_agent_core::api::tool::ToolExecutionContext::standalone("plugin_echo"),
