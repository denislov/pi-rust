...
const INTERACTIVE_APP_SOURCE: &str = include_str!("../../src/adapters/interactive/app.rs");
const INTERACTIVE_LOOP_SOURCE: &str = include_str!("../../src/adapters/interactive/loop.rs");
const RPC_MODE_TEST_SOURCE: &str = include_str!("../rpc/mode.rs");
const PROTOCOL_SESSIONS_TEST_SOURCE: &str = include_str!("../recovery/protocol_sessions.rs");
