...
use pi_coding_agent::api::operation::{CodingAgentOperation, CodingAgentOperationOutcome};
use pi_coding_agent::api::runtime::{CodingAgentSession, CodingAgentSessionOptions};
use pi_coding_agent::api::view::ProfileId;
...
async fn set_default_agent_profile_updates_manifest_and_emits_event() {
    ...
    assert_eq!(
        event.family_typed(),
        pi_coding_agent::api::event::CodingAgentProductEventFamily::Profile
    );
