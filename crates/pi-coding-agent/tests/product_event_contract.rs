...
use pi_coding_agent::api::{
    ...
    CodingAgentProductEventTerminalStatus, CodingAgentSession, CodingAgentSessionOptions,
    CodingAgentSessionProductEvent, CodingAgentWorkflowProductEvent, PromptInvocation,
