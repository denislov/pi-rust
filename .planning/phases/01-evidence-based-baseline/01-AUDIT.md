...
|----|-----------|-------------|-------------|----------|--------------|--------------|--------------|-----------|------|---------|
| F-BASE-01 | informational | active | Facade/dispatcher/navigation baseline is complete: run() uses metadata-selected async/sync-read-only/sync-mutable dispatch with no compat calls, all 15 variants map exhaustively to internal operations and outcomes, and fork/switch preserve owner runtime, event continuity, and report partial commit | SRC-OP-02, SRC-OP-03, SRC-OP-05, GUARD-DISPATCH-01, TEST-API-01, TEST-OWNER-01, TEST-OWNER-02, TEST-OWNER-03, TEST-OWNER-04, TEST-OWNER-07 | FACADE-02, FACADE-03, FACADE-05 | Phase 2 | none | high | none | none |
| F-ADAPT-01 | required | active | No production adapter uses CodingAgentSession::run(); all JSON, print, RPC, and interactive callers invoke deprecated compatibility methods with local #[allow(deprecated)] suppressions | SCAN-PROD-01, SCAN-PROD-02, SCAN-PROD-03, SRC-OP-05, GUARD-DISPATCH-01 | ADAPT-01, ADAPT-02, ADAPT-04, RPC-01, RPC-02, RPC-04, INTER-01, INTER-02, INTER-05 | Phase 3 | facade correctness complete (F-BASE-01, SRC-OP-05, GUARD-DISPATCH-01) | high | none | none |
