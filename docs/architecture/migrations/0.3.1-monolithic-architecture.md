# Archived 0.3.1 Monolithic Target Architecture

## 1. Document Status

This document preserves the monolithic architecture baseline that was normative
through `0.3.1`. It is historical migration evidence after the `0.4.0`
architecture split and is not the active normative index. Active contracts live
under `docs/architecture/` and are indexed by `docs/architecture.md`.
