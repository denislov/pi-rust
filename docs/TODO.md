...
- [~] Keep old `session_runner` as transitional wrapper. It remains the execution source for unmigrated JSON execution and interactive paths while print and RPC prompt execution route through `CodingAgentSession`/`CodingAgentEvent`.
